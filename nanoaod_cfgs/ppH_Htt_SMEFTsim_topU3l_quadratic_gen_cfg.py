...
# with command line options: Configuration/GenProduction/python/pythia_fragment.py --mc --python_filename ppH_Htt_SMEFTsim_topU3l_quadratic_gen_cfg.py --eventcontent RAWSIM,LHE --datatier GEN,LHE --conditions 130X_mcRun3_2023_realistic_postBPix_v5 --beamspot Realistic25ns13p6TeVEarly2023Collision --step LHE,GEN --nThreads 1 --geometry DB:Extended --era Run3_2023 --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=123 --fileout file:gen.root --no_exec --number 50 --number_out 50
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/pythia_fragment.py nevts:50'),
