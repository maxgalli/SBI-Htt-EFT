...
# with command line options: --python_filename ppH_Htt_SMEFTsim_topU3l_quadratic_miniaod_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:miniaod.root --conditions 130X_mcRun3_2023_realistic_postBPix_v5 --step PAT --geometry DB:Extended --filein file:aod.root --era Run3_2023 --no_exec --mc -n 10
