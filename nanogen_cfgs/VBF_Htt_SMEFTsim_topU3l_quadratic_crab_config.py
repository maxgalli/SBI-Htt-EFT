...
config.General.requestName     = 'VBF_Htt_SMEFTsim_topU3l_quadratic_gennanogen_100kevents'
...
config.JobType.inputFiles = [
    '/eos/user/z/zhaom/htautau/samples/SBI-Htt-EFT/genproductions_mg35x_gh/bin/MadGraph5_aMCatNLO/VBF_Htt_SMEFTsim_topU3l_quadratic_el8_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'
]
